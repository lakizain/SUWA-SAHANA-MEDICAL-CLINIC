# SUWA SAHANA MADICAL CLINIC - Backend System

## Overview

This is a comprehensive backend system for the SUWA SAHANA MADICAL CLINIC management system, built with JavaScript and Supabase. The system provides full CRUD operations for billing, test management, reference management, center management, and package management.
...
- **Center Management**: Clinic center management
