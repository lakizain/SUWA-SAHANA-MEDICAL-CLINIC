...
class ReportEntryController {
  ...
  getValueDecimalPlacesForTest(testId) {
    return testId === THREE_DECIMAL_VALUE_TEST_ID ? 3 : 2;
  }
  ...
  limitValueInputToDecimals(rawValue, finalize = false, decimalPlaces = 2) {
    const dp = Math.max(0, Math.min(20, Number(decimalPlaces) || 2));
  ...
  bindDecimalConstraint(inputElement, decimalPlacesSource = 2) {
