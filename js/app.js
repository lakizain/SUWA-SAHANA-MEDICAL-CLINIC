...
class LaboratoryApp {
  ...
  async initialize() {
    try {
      console.log("Initializing SUWA SAHANA MADICAL CLINIC Management System...");
      ...
      console.log("SUWA SAHANA MADICAL CLINIC Management System initialized successfully");
